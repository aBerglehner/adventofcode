...
//                System.out.println("--------------");
                if (isHorizontalReflection(matrix, upperBound, bottomBound) == 1) {
...
//                System.out.println("rightBound = " + rightBound);
                if (isVerticalReflection(matrix, leftBound, rightBound) == 1) {
//                    System.out.println("vertical result: " + i);
    ...
    private static int isVerticalReflection(List<List<String>> matrix, int left, int right) {
        int sum = 0;
        while (left < right) {
    ...
    private static int isHorizontalReflection(List<List<String>> matrix, int top, int bottom) {
        int sum = 0;
        while (top < bottom) {
